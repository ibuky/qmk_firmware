 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | GUI | Alt  | Menu  | Space| Lower| Raise| KANA | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    KC_ESC,  KC_LGUI, KC_APP,  KC_LALT, KC_SPC,  LOWER,   RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    _______, KC_LT,   KC_GT,   KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_EQL,  KC_PLUS, KC_MINS, _______, KC_QUOT,
    _______, _______, _______, KC_QUOT, KC_DQUO, KC_LPRN, KC_RPRN, _______, _______, _______, _______, _______,
