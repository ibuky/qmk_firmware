...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_GAME1] = LAYOUT(
        // Main Keys
                                            GC_R1,
        GC_DPL,     GC_DPD,     XXXXXX,     XXXXXX,     GC_SQU,     GC_CRO,     GC_CIR,     XXXXXX,
                    XXXXXX,     GC_DPR,     XXXXXX,     GC_TRI,     XXXXXX,     XXXXXX,     XXXXXX,
                    XXXXXX,     GC_DPU,     GC_R2,      GC_L1,
        // Function Keys
                                GC_HOM,     GC_SEL,     GC_STA,     XXXXXX,     XXXXXX,     XXXXXX
    ),
};
